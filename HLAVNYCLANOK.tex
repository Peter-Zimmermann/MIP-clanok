...
\begin{figure}[h]
\includegraphics[scale=0.75]{porovnanie.png}
\centering
...
Táto prednáša bola zameraná na grafické vyjadrenie informácií v informatike, kde sa ako hlavné témy rozoberali vizualizácia, prečo je grafické vyjadrenie informácií dôležité, aké sú ich nástroje a využitia a ich praktická realizácia. Vizualizácia je nejaké znázornenie, alebo formalizácia daného predmetu. Z môjho pohľadu je vizualizácia v akomkoľvek smere veľmi dôležitá, keďže je lepšie raz vidieť, ako viackrát počuť.

\paragraph{Načo budem inžinierom (bakalárom) ?} 
Táto prednáška medzi moje najobľúbenejšie, keďže bol na ňu pozvaný dekan Fakulty Informatiky a Informačných Technológií STU, prof. Ing. Ivan Kotuliak, Phd. Prednášal nám rozsiahlé informácie, ktoré boli podané veľmi interaktívnou formou, ktoré sa týkali napríklad motivácie  pre štúdium, platy v IT na Slovensku, profesie v IT, alebo vedy. Dozvedel som sa mnoho nových informácií, hlavne z psychologického hľadiska a samozrejme z pohľadu pôsobenia v IT. 
...
Poslednou a z môjho pohľadu najdôležitejšou a najzaujímavejšou témou tohto článku bol spôsob modelovania automobilky Tesla. V tejto kapitole som podrobnejšie vysvetlil najnovsím spôsob, akým táto automobilová firma modeluje ostatné vozidlá, budovy, chodcov, alebo ostatné objekty. 
