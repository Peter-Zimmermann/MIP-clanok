...
\subsection{Proces testovania sloftvéru} \label{procestestovania}
...
\begin{figure}
\centering
\includegraphics[scale=0.3]{vmodeltestovania}
\caption{Znázornenie procesu testovania softvéru a jeho jednotlivých krokov.}
\end{figure}



\section{Modelovanie nebezpečenstva a predikcia možnej autonehody} \label{modelovanie}
...
%\acknowledgement{Peter Zimmermann st. -otec}
