...
\end{enumerate}
\begin{figure}
\includegraphics[scale=0.5]{diagramtestovanie.jpg}
\centering
...
Vďaka ich progresívnosti a futuristickému zmýšlaniu, Tesla využíva najmodernejšie a najviac inovatívne funkcie a postupy pri vytváraní ich softvérov. 
...
Vďaka tomuto spôsobu je možné modelovať aj ostatné 3D objekty, ktoré sa nachádzajú na, alebo popri vozovke, ako napríklad budovy, prekážky, chodníky, autá, alebo ľudia. \cite{Tesla:AID}
